...
if(!processArguments()) console.error("[ERROR] You must specify the input using the -i flag.");
    ...
    compiler.init();
    compiler.include(require('jssharp'));
    compiler.include(require('inqscript'));
    compiler.include(require('cellscript'));
    if(includeExperimental) compiler.include(require('js-experimental'));
